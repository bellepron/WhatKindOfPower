...
public class SkillAdder_GreatSworder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        fireSword = SwitchWeapon.Instance.arsenal[3].equipments[0].transform.GetChild(5).gameObject;
        blackSword = SwitchWeapon.Instance.arsenal[3].equipments[0].transform.GetChild(6).gameObject;
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.GetComponent<AttackTypes>() != null)
        {
            ...
            if (addType == AddType.FireSowrd)
            {
                Globals.greatSword_Index = 1;
                fireSword.SetActive(true);
            }
            if (addType == AddType.BlackSword)
            {
                Globals.greatSword_Index = 2;
